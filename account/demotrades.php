...
$tradesQuery = "SELECT trade_time, symbol, amount, strike_rate, end_price, end_time, status, trading_type, transaction_id, username FROM demo_trades";
                    ...
                    <div class="dropdown-inner user-card-wrap bg-lighter d-none d-md-block">
                      <div class="user-card">
                        ...
                        <div class="user-info">
                          ...
                          <span class="sub-text">support@proinvestengine.com</span>
                        </div>
        ...
        <div class="nk-content-body">
          <div class="nk-block-head text-center">
            <div class="nk-block-head-content">
              ...
              <div class="nk-block-head-content">
                <h2 class="nk-block-title fw-normal">DEMO TRADES</h2>
